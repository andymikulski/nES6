import BlipImpulse from './BlipImpulse.js';
...
export default class BlipSynth {
	constructor(quality, range) {
	...
	static blip_low_quality = 1;
	static blip_med_quality = 2;
	static blip_good_quality = 3;
	static blip_high_quality = 4;

	static calc_fine_bits(abs_range) {
	...
	offset_resampled(time, delta, blip_buf) {
