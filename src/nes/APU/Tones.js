...
export class Envelope extends Osc {
	constructor(){
		super();
		this.envelope = 0;
		this.env_delay = 0;
...
export class Square extends Envelope {
	constructor() {
		super();
		this.phase = 0;
		this.sweep_delay = 0;
	...
	static negate_flag = 0x08;
	static shift_mask = 0x07;
	static phase_range = 8;

	clock_sweep( negative_adjust ) {
...
export class Triangle extends Osc {
	constructor(){
		super();
		this.phase = this.phase_range;
		this.linear_counter = 0;
		this.synth = new BlipSynth( BlipSynth.blip_good_quality, 15 );
	}
	static phase_range = 16;
...
export class Noise extends Envelope {
	constructor(){
		super();
		this.noise = 0x4000;
		this.synth = new BlipSynth( BlipSynth.blip_med_quality, 15 );
	}
...
export class Dmc extends Osc {
	constructor( apu ) {
		...
		this.synth = new BlipSynth( BlipSynth.blip_med_quality, 127 );
