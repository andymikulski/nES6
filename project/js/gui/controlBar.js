...
(function(){
	...
	var ControlBar = function( app ) {
		...
		this._app.connect( 'cartLoaded', ::this._onCartLoaded);
		this._app._mainboard.connect( 'soundEnabled', ::this._onSoundEnabled);
		this._app.connect( 'traceRunning', ::this._onTraceRunning);
		this._app.connect( 'frameLimit', ::this._onFrameLimitSet);
		this._app.connect( 'isPausedChange', ::this._onPauseChange);
		this._app.connect( 'romLoadFailure', ::this._onRomLoadFailure);
