...
(function(){
	...
	var Nes_Apu = function() {
		...
		this.square1 = new Nes.Nes_Square();
		this.square2 = new Nes.Nes_Square();
		this.triangle = new Nes.Nes_Triangle();
		this.noise = new Nes.Nes_Noise();
		this.dmc = new Nes.Nes_Dmc();
		...
		this.square_synth = new Nes.Blip_Synth( Nes.Blip_Synth.blip_good_quality, 15 );
	...
	//	require( (unsigned) data <= 0xff );
		...
		if ( addr < 0x4014 ) {
			...
			var recalc_irq = this.dmc.irq_flag;
	...
	Nes_Apu.prototype.read_status = function( time ) {
		...
		var result = ( this.dmc.irq_flag ? 0x80 : 0 ) | ( this.irq_flag ? 0x40 : 0 );
