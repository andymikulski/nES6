...
var WebGlRenderSurface = function () {
	function WebGlRenderSurface(canvasParent) {
		...
		this._clearArray = new _typedarray.Uint32Array(SCREEN_WIDTH * SCREEN_HEIGHT);
		this._clearArrayColour = this._clearArray[0];

		this._bufferIndexArray = new _typedarray.Int32Array(SCREEN_WIDTH * SCREEN_HEIGHT);
		this._offscreen32BitView = new _typedarray.Uint32Array(TEXTURE_WIDTH * TEXTURE_HEIGHT);
		this._offscreen8BitView = new _typedarray.Uint8Array(this._offscreen32BitView.buffer);
	...
	_createClass(WebGlRenderSurface, [{
		...
		value: function _initBuffers() {
			...
			var vertices = new Float32Array([0, 0, 0.0, 1.0, SCREEN_WIDTH, 0, 0.0, 1.0, SCREEN_WIDTH, SCREEN_HEIGHT, 0.0, 1.0, 0, SCREEN_HEIGHT, 0.0, 1.0]);
